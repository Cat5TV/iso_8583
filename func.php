...
*/
  function montrans($type,$code) {
	  ...
	  switch ($type) {
			...
			case 'cc':
				/*
					Return the textual name of a credit card based on the Card Type response
					Usage: montran('cc',$mpgResponse->getCardType())
				*/
			...
			case 'iso':
				/*
					Return the textual meaning of a provided ISO 8583 Response Code.
					See https://en.wikipedia.org/wiki/ISO_8583#Response_code
					Usage: montran('iso',$mpgResponse->getISO())
				*/
				switch ($code) {
					case '00':
				...
				default:
					$resp = 'An unknown response code type was passed to the function. Please inspect the code carefully and ensure you are using the proper code for $type.';
					break;
			}
